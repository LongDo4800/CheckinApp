...
public class ProfileController {
    ...
    public Map<String, Object> signIn(@RequestBody Profile rqProfile) throws Exception {
        ...
        if(!(profile.isEmpty())){
            ...
            Sitener sitenerRs = new Sitener(sitener.getId(),sitener.getName(),sitener.getBirthday(),sitener.getClassID(),sitener.getEmail(),sitener.getAddress(),sitener.getPhoneNo(),sitener.getAvatar());
