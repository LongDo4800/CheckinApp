...
public interface ProfileRepository extends JpaRepository<Profile, Integer> {
    ...
    @Query("select a.username,a.password from Profile a where a.username =:username and a.password =:password")
    ArrayList checkUsernameAndPass(String username, String password);
